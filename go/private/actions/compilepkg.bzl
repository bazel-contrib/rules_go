...
def _go_srcs_only(f):
    # The cgo sources directory carries a marker file so that it is never empty,
    # which remote execution requires of declared output directories.
    # TODO: Drop this along with the marker file in compilepkg.go once Bazel
    # reports empty output directories.
