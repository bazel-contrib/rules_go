...
def go_rules_dependencies(force = False):
    ...
    wrapper(
        ...
        # v0.48.0, from 2026-07-09
        urls = [
            "https://mirror.bazel.build/github.com/golang/tools/archive/refs/tags/v0.48.0.zip",
            "https://github.com/golang/tools/archive/refs/tags/v0.48.0.zip",
        ],
        sha256 = "a3356cee2a1b6c808292e7e1cd20fe0355057b1b661908f15ec76fd0ba2dd3ab",
        strip_prefix = "tools-0.48.0",
        patches = [
